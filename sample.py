        ...
        for ticker in tickers:
            ...
            if current_cash and current_cash > 1:
                ...
                if rec1 == OrderType.BUY_RECOMMENDATION and rec2 == OrderType.BUY_RECOMMENDATION:
                    ...
                    print(
                        f"Bought {ticker} at ${tb0.get_current_market_price(ticker)}")
